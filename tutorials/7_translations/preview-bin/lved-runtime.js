...
var ASM_CONSTS = {
 ...
 171614: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 171697: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 171766: () => { return window.innerWidth; },  
 171796: () => { return window.innerHeight; }
};
