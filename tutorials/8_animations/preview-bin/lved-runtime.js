...
var ASM_CONSTS = {
 ...
 164846: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 164929: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 164998: () => { return window.innerWidth; },  
 165028: () => { return window.innerHeight; }
};
