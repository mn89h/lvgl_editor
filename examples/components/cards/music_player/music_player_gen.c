...
lv_obj_t * music_player_create(lv_obj_t * parent)
{
    ...
    lv_slider_set_start_value(slider_0, 0, false);lv_slider_set_min_value(slider_0, 0);
    ...
    lv_label_bind_text(lv_label_2, &song_played, "%d");lv_obj_set_style_text_font(lv_label_2, geist_semibold_12, 0);
