...
function js_log_callback(message) { if (typeof window !== 'undefined') { window.dispatchEvent(new CustomEvent('lvgl-log', { detail: UTF8ToString(message) })); console.log(UTF8ToString(message)); } if (typeof process !== 'undefined') { console.log('[LVGL]' + UTF8ToString(message)); } }
